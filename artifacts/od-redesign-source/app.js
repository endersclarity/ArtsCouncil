  ...
  function addMapLayers() {
    ...
    state.map.addLayer({
      ...
      paint: {
        ...
        // De-overloaded red: selection is a SOLID filled red core; anchors keep
        // a dark fill + hollow red ring. Fill-vs-ring is the categorical signal
        // so a selected place is unmistakable even among anchor rings.
        "circle-color": ["case", ["get", "selected"], MARKERS.red, MARKERS.place],
        "circle-opacity": 1,
        "circle-stroke-color": MARKERS.paper,
        "circle-stroke-width": ["case", ["get", "selected"], 2.6, 1.8],
      },
    });
    state.map.addLayer({
      id: "place-hover-ring",
    ...
    state.map.addLayer({
      ...
      paint: {
        "circle-radius": ["case", ["get", "selected"], 16, ["get", "anchor"], 14, 12],
        "circle-color": "rgba(255,255,255,0)",
        "circle-stroke-color": MARKERS.red,
        "circle-stroke-width": ["case", ["get", "selected"], 3.4, 2.4],
        "circle-opacity": ["case", ["get", "selected"], 1, 0.9],
      },
    });
    state.map.addLayer({
